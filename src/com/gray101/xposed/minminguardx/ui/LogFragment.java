package com.gray101.xposed.minminguardx.ui;
...
import com.gray101.xposed.minminguard.R;
    ...
    public void refresh() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                final String pname = "com.gray101.xposed.minminguardx";
                if (context.getPackageManager().checkPermission(android.Manifest.permission.READ_LOGS, pname) != 0) {
                    if (android.os.Build.VERSION.SDK_INT >= 16) {
                        progs.add("su");
                        progs.add("-c");
                        progs.add("pm grant com.gray101.xposed.minminguardx android.permission.READ_LOGS");
                        try {
